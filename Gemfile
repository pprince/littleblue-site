...
# Compass 1.0 is almost out!  w00t!
gem 'compass', :github => 'pprince/compass', :branch => 'ppdevel' # 1.0.0.alpha.18

# I wanted to use both sass-globbing and compass-import-once,
# however, they interfere with each other!  bragh!
# See: https://github.com/chriseppstein/compass/issues/1529
# FIXME: There is a work-around that I have been asked to try.
gem 'sass-globbing'
